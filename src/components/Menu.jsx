    ...
    <div>
        {isClicked && (
            <div onClick={() => handleMenuClose()} className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
                <section className={`${isClicked ? 'translate-x-0' : 'translate-x-[-100%]'} h-screen s:w-[75%] sm:w-[75%] md:w-[75%] lg:w-[300px] xl:max-w-[300px] fixed top-0 right-0 bg-[#f7faf9] z-10 transition-all duration-200 transform shadow-2xl`}>
                <div className=''>
